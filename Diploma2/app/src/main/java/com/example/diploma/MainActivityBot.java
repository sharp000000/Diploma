...
public class MainActivityBot extends AppCompatActivity implements View.OnClickListener {

    public static final String TAG = MainActivityBot.class.getName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final LanguageConfig config = new LanguageConfig("ru", "1bbc5dd13a4e4b63829a0d92c56a2df7");
        initService(config);
    }
    ...
    private void initChatView() {
        int myId = 0;
        Bitmap icon = BitmapFactory.decodeResource(getResources(), R.drawable.nowaste);
        String myName = "";
        ...
        chatView.setLeftBubbleColor(R.color.lightBlue500);
        ...
        chatView.setInputTextHint("Повідомлення...");
